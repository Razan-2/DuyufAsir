...
const agents = {
    ...
    housing: { icon: "fa-house", listTitle: "السكن والفنادق ونُزل الإيواء التراثية في عسير", features: [
        ...
        { name: "نُزل الحصون التراثية", location: "قرية رجال ألمع التراثية – رجال ألمع", people: "أفراد وعائلات", rooms: "إقامة في حصون حجرية بطابع عسيري", nightly: "السعر والتوفر لدى مقدم الإقامة", nightlyRate: 0, monthly: "تجربة إقامة تراثية", monthlyRate: 0, image: "assets/entertainment/productive-families-abha.jpg", mapUrl: "https://www.google.com/maps/search/?api=1&query=نزل+الحصون+التراثية+رجال+ألمع", bookingUrl: "https://ar.airbnb.com/rijal-almaa-saudi-arabia/stays", bookable: true, heritageStay: true },
        { name: "نُزل قرية عنقرة التراثية", location: "قرية عنقرة – جنوب شرق أبها", people: "أفراد وعائلات", rooms: "غرف تراثية وتجربة ريفية جنوبية", nightly: "السعر والتوفر لدى مقدم الإقامة", nightlyRate: 0, monthly: "تجربة ريفية وتراثية", monthlyRate: 0, image: "assets/agents/housing-abha-authentic.jpg", mapUrl: "https://www.google.com/maps/search/?api=1&query=قرية+عنقرة+عسير", bookingUrl: "https://www.google.com/maps/search/?api=1&query=قرية+عنقرة+عسير", bookable: true, heritageStay: true },
